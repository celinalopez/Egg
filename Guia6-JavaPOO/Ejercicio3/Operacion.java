...
16
e) Método sumar(): calcular la suma de los números y devolver el resultado al app.main.
f) Método restar(): calcular la resta de los números y devolver el resultado al app.main
g) Método multiplicar(): primero valida que no se haga una multiplicación por cero,
si fuera a multiplicar por cero, el método devuelve 0 y se le informa al usuario el
error. Si no, se hace la multiplicación y se devuelve el resultado al app.main
