...
public class Main {
    public static void main(String[] args) {
        ...
        //Hacer esto en clase juego
        System.out.println("Numero de jugadores: ");
        int value = leer.nextInt();
        for (int i = 0; i < value; i++) {
            Jugador nuevoJ = new Jugador();
            lista_jugadores.add(nuevoJ);
        }

        Revolver r = new Revolver();
        juego1.setRevolver(r);
        juego1.llenarJuego(lista_jugadores, r);
        System.out.println("LISTA DE JUGADORES: ");
        System.out.println(juego1.getJugadores());
        System.out.println("--------COMIENZA EL JUEGO---------");
        juego1.ronda();
        System.out.println("DATOS DEL REVOLVER:");
